...
Route::get('/pembayaran/get-data/{id_billing}', [PembayaranController::class, 'getData']);
Route::get('/pembayaran/search-billing', [PembayaranController::class, 'searchBilling']);
...
Route::middleware(['auth'])->group(function () {
    ...
    //Pembayaran
    Route::get('/pembayaran/billing', [PembayaranController::class, 'index'])->name('pages.pembayaran.index');
    Route::post('/pembayaran/store', [PembayaranController::class, 'store'])->name('pembayaran.store');
});

Route::get('/laporan/pembayaran', [LaporanPembayaranController::class, 'index'])->name('pages.laporan.pembayaran.index');
